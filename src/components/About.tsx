...
const About: React.FC = () => {
    return (
        <section id="about" className="relative mt-20 bg-linear-to-br from-primary-navy via-primary-navy/95 to-primary-navy text-white py-20 md:py-32 overflow-hidden rounded-[2rem] md:rounded-[4rem] mx-4 md:mx-8">
